...
class PyDagItr(MayaToPyItr):
    ...
    def __init__(self, mit_dag="<maya.OpenMaya.MItDag; proxy of <Swig Object of type 'MItDag *' at 0x14b3820f0> >"):
        pass
...
class PyDepNodesItr(PyDepGraphItr):
    ...
    def __init__(self, mit_dependency_nodes="<maya.OpenMaya.MItDependencyNodes; proxy of <Swig Object of type 'MItDependencyNodes *' at 0x14b382180> >", filter=0, miterator_type=None):
        """
