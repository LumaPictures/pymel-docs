...
class MPxFileResolver(_object):
    ...
    def resolveURIWithContext(*args, **kwargs):
        pass
...
class MFnPlugin(OpenMaya.MFnBase):
    ...
    def deregisterAnimCurveInterpolator(*args, **kwargs):
        pass
    ...
    def registerAnimCurveInterpolator(*args, **kwargs):
        pass
...
class MPxNode(_object):
    ...
    def schedulingType(*args, **kwargs):
        pass
...
class MPxAssembly(MPxNode):
    ...
    def postApplyEdits(*args, **kwargs):
        pass
    ...
    def postUnapplyEdits(*args, **kwargs):
        pass
...
class MPxManipContainer(MPxNode):
    ...
    def addPlugToInViewEditor(*args, **kwargs):
        pass
...
class MPxTexContext(MPxContext):
    ...
    def portSize(*args, **kwargs):
        pass
    
    
    def portToView(*args, **kwargs):
        pass
    
    
    def viewRect(*args, **kwargs):
        pass
    
    
    def viewToPort(*args, **kwargs):
        pass
...
class MPxMotionPathNode(MPxNode):
    ...
    def evaluatePath(*args, **kwargs):
        pass
    
    
    def fractionalToParametric(*args, **kwargs):
        pass
    
    
    def getVectors(*args, **kwargs):
        pass
    ...
    def parametricToFractional(*args, **kwargs):
        pass
    ...
    def wraparoundFractionalValue(*args, **kwargs):
        pass
    ...
    orientationMarkerTime = None
    
    pathGeometry = None
    
    positionMarkerTime = None
...
class MPxManipulatorNode(MPxNode):
    ...
    def shouldDrawHandleAsSelected(*args, **kwargs):
        pass
...
class MPxBlendShape(MPxGeometryFilter):
    ...
    inputGeomTarget = None
    
    inputPointsTarget = None
    
    inputTarget = None
    
    inputTargetGroup = None
    
    inputTargetItem = None
