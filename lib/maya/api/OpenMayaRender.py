...
class MRenderer(object):
    ...
    kR10G10B10A2_UINT = 50
    
    
    kR10G10B10A2_UNORM = 49
    
    
    kR16G16B16A16_FLOAT = 58
    
    
    kR16G16B16A16_SINT = 62
    
    
    kR16G16B16A16_SNORM = 60
    
    
    kR16G16B16A16_UINT = 61
    
    
    kR16G16B16A16_UNORM = 59
    ...
    kR32G32B32A32_FLOAT = 66
    
    
    kR32G32B32A32_SINT = 68
    
    
    kR32G32B32A32_UINT = 67
...
class MPxSubSceneOverride(object):
    ...
    def setGeometryForRenderItem(*args, **kwargs):
        """
        setGeometryForRenderItem(renderItem, vertexBuffers, indexBuffer, objectBox=None) -> self
        ...
        * indexBuffer (MIndexBuffer) - The index buffer for the geometry.
...
class MPxGeometryOverride(object):
    ...
    def refineSelectionPath(*args, **kwargs):
        ...
        One can decide to change the selection mask of the object (ie: override the selection mask return by a component converter).
...
class MSceneRender(MRenderOperation):
    ...
    def displayModeOverride(*args, **kwargs):
        ...
        Query for any display mode override.
          ...
          MSceneRender.kTextured               Display textured. Only applicable if kSmoothShaded or kFlatShaded is enabled.
        """
