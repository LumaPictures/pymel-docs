...
class QAudioEngineFactoryInterface(_QtCore.QFactoryInterface):
    ...
    def createDeviceInfo(*args, **kwargs):
        pass
...
class QAudioDeviceInfo(_Object):
    ...
    def supportedChannels(*args, **kwargs):
        pass
    ...
    def supportedFrequencies(*args, **kwargs):
        pass
...
class QAbstractAudioDeviceInfo(_QObject):
    ...
    def byteOrderList(*args, **kwargs):
        pass
    
    
    def channelsList(*args, **kwargs):
        pass
    
    
    def codecList(*args, **kwargs):
        pass
    ...
    def sampleSizeList(*args, **kwargs):
        pass
    
    
    def sampleTypeList(*args, **kwargs):
        pass
...
class QAudioEnginePlugin(_QObject, QAudioEngineFactoryInterface):
    def __init__(*args, **kwargs):
        """
        x.__init__(...) initializes x; see help(type(x)) for signature
        """
